...
export default function Header() {
  ...
  return (
    ...
    >
          ...
          <nav className="hidden md:block" aria-label="Main navigation">
            ...
            >
              {[
                ...
                { name: "Achievements", href: "#achievements-education" },
      ...
      {/* Mobile Menu */}
      <motion.div
        className={`absolute top-16 left-0 right-0 bg-black/90 backdrop-blur-md border-b border-cyan-500/20 z-40 ${
          ...
          >
            {[
              ...
              <motion.a
                key={navItem.name}
                href={navItem.href}
                className="text-gray-300 hover:text-cyan-400 transition-colors duration-300 text-lg font-medium py-2 border-b border-gray-800"
